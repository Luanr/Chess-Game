    	...
    	*/
    	...
    	try {
    		if(jogadaValida(xi, yi, xf, yf, lado)) {
    			...
    			let mensagem = {tipo:'ATUALIZA_TABULEIRO',valor:partida.tabuleiro};
...
function inserePartida(player1, player2, tabuleiro) {    
 	...
 	var partida = {player1: player1, player2:player2, tabuleiro: tabuleiro, vez: 0}
